...
<head>
    ...
    <link rel="preconnect" href="https://cdn.jsdelivr.net" crossorigin>    <!-- Custom CSS -->    <!-- Base styles first -->
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/pizza-detail.css">
